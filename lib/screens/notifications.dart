                ...
                builder: (
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        notifyData[index]['tipo'] == "feedback"? notifyData[index]['mensaje'] == "Pago aceptado"? null:debugPrint('este es el id:'+notifyData[index]['idNotificador']):null;
                                      ...
                                      child: NotifyPic(sesionId: sesionId, notificadorId: notifyData[index]
                                            ...
                                            notifyData[index]['mensaje'] ==
                                                ...
                                                : SizedBox(
                                                  width: 40,
                                                  child: Center(
                                                    child: NotifyPic(sesionId: sesionId, notificadorId: notifyData[index]['idNotificador'],),
